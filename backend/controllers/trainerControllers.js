...
const registerTrainer = asyncHandler(async (req, res) => {
  const{fname,lname,username,nic,dob,gender,mobile,address,qualifications,yrsexp,password,pic}=req.body;
...
module.exports = { registerTrainer, authTrainer, updateTrainerProfile };
