      ...
      <div className="content contact-list">
        <div className="card card-default"  style={{background:'transparent', border:'1px solid grey',boxShadow:'7px 7px 60px white'}}>
            <div className="card-header align-items-center px-3 px-md-5">
                ...
                <div className="btnAdd"> <a href="/employee/trainer-register"><span>Add Trainer</span></a> </div>
            </div>
            ...
            <div className="card-body px-3 px-md-5" >
                ...
                {this.state.details.map((details) => (
                    <div className="col-lg-6 col-xl-4 col-md-6 col-sm-12">
                        <div className="card card-default p-4"  style={{background: `linear-gradient( rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75))`,boxShadow:'7px 7px 60px grey',border:'2px solid #c9c9c9'}}>
                            <img src={details.pic} className="mr-3 img-fluid rounded" style={{border:'2px solid #c9c9c9'}}/>
                                <div className="media-body">
                                    <div  style={{marginLeft:'115px',marginTop:'-100px',color:'#dcdcdc',fontSize:14}}>{details.fname} {details.lname}</div>
                                    <hr style={{marginLeft:'115px',color:'#c9c9c9',marginTop:'10px'}}/>
                                    <ul className="list-unstyled text-smoke text-smoke">
                                        <li className="d-flex" style={{marginLeft:'115px',color:'#c9c9c9'}}>
                                            <i className="mdi mdi-map mr-1"></i>
                                            <span style={{fontSize:11}}>Address : {details.address}</span>
                                        </li>
                                        <li className="d-flex" style={{marginLeft:'115px',color:'#c9c9c9'}}>
                                            <i className="mdi mdi-email mr-1"></i>
                                            <span style={{fontSize:11}}>Gender&nbsp; : {details.gender}</span>
                                        </li>
                                        <li className="d-flex" style={{marginLeft:'115px',color:'#c9c9c9'}}>
                                            <i className="mdi mdi-email mr-1"></i>
                                            <span style={{fontSize:11}}>DOB&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style={{marginLeft:'-2px'}}> : {details.dob}</span></span>
                                        </li>
                                        <li className="d-flex" style={{marginLeft:'115px',color:'#c9c9c9'}}>
                                            <i className="mdi mdi-email mr-1"></i>
                                            <span style={{fontSize:11}}>ExpYrs&nbsp;  <span style={{marginLeft:'4px'}}>: {details.yrsexp}</span></span>
                                        </li>
                                        <li className="d-flex" style={{marginLeft:'115px',color:'#c9c9c9'}}>
                                            <i classNames="mdi mdi-phone mr-1"></i>
                                            <span style={{fontSize:11}}>Contact&nbsp;: {details.mobile}</span>
                                        </li>
                                        <li className="d-flex" style={{marginLeft:'',marginTop:'-25px',color:'#848482'}}>
                                            <i className="mdi mdi-email mr-1"></i>
                                            <span style={{fontSize:9}}>@{details.username}</span>
                                        </li>
                                    </ul>
                                  </div>
                                </div>
