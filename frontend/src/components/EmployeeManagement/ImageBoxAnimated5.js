...
const ImageBox = styled.div`
  ...
  height: 90vh;
  margin-left: 55px;
  background: url("https://res.cloudinary.com/djg9iitcl/image/upload/v1631384991/portrait-young-healthy-woman-running-treadmill-she-smile-during-workout-gym-healthy-lifestyle-concept-copy-space-vertical-image_o6o8dn.jpg");
