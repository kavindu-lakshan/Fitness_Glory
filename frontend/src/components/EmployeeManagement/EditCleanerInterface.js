    ...
    return (
        <div>
            ...
            <div>
                <div style = {bgStyles}>
                    <Fade left>
                        <img src = "https://res.cloudinary.com/djg9iitcl/image/upload/v1631102458/woman-gym-body-building_ddfg1z.jpg" alt = "Carousel image failed to load" style = {imageStyles2}></img>
                        <h1 style = {headingStyles2}>UPDATE EMPLOYEE INFORMATION</h1>
                    </Fade>
                    </div>
                    <br></br><br></br><br></br>
                </div>
                        ...
                        <div>
                            <MDBCard style={cardStyles}>
                                <MDBRow className='g-0'>
                                    <MDBCol md='4'>
                                        <MDBCardImage src='https://res.cloudinary.com/djg9iitcl/image/upload/v1631102031/Card8_zem1f4.jpg' alt='...' fluid  style = {imageStyles}/>
                                    </MDBCol>
                                    <MDBCol md='8'>
                                        <MDBCardBody>
