...
export default function AllProgramsView(props) {
  ...
  return (
    <div data-aos="fade-top" className="container">
        ...
        <tbody>
          {props.values.map((program, index) => (
            <tr key={index}>
              ...
              <td>
                <a
                  href={"/admin/expand-program/" + program._id}
              ...
              <td>
                <a
                  ...
                  href={"/admin/edit-program/" + program._id}
                >
                ...
                <a
                  ...
                  style={{ width: "100%", marginBottom: "2px" }}
                  href=""
                  onClick={() => props.onDelete(program._id, program.name)}
                >
      ...
      <button className="btn btn-info mb-2 mx-3">
        {" "}
        <a
          href="/admin/programsReport"
          style={{ textDecoration: "none", color: "white" }}
        >
          Programs Stats
        </a>
