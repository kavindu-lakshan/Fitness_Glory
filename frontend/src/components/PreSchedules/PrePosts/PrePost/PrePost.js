...
const PrePost = ({prepost, setCurrentId}) => {
    ...
    return (
      ...
      <div className={classes.overlay}>
        <Typography style={{ color: 'white' }} variant="h6">{prepost.creator}</Typography>
        <Typography  style={{ color: 'white' }} variant="body2">{moment(prepost.createdAt).fromNow()}</Typography>
